...
public interface DeviceStatusMapper {
    ...
    @Insert("INSERT INTO ip_device_status(device_id, device_name,device_para_name,device_para_value)" +
            "VALUES(#{deviceStatus.deviceId}, #{deviceStatus.deviceName},#{deviceStatus.deviceParaName}, #{deviceStatus.deviceParaValue})")
